    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<NewsBusinessesSearchResponse>() {
            ...
            public void onResponse(Call<NewsBusinessesSearchResponse> call, Response<NewsBusinessesSearchResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(articles, SPortsNews.this); //pass mNews and activity
                    recyclerView.setAdapter(newsAdapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(SPortsNews.this));   // set layout manager as the current context
        ...
        ImageViewNotesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SPortsNews.this, MyNotes.class);
